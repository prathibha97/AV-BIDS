        ...
        <div className="grid sm:grid-cols-2 gap-x-16 gap-y-4 font-medium text-[16px] text-[#353535]">
          ...
          <div className="">
            ...
            <div className="mb-5">
              <Select
                label="In-Person"
                className="!bg-input_background rounded-lg"
                name="eventType"
                onChange={(e: any) => {
          ...
          <div className="">
            ...
            <div className="mb-5">
              <Input
                ...
                crossOrigin=""
                className="!border !border-gray-300 !bg-input_background  text-gray-900 ring-transparent placeholder:text-gray-500 focus:!border-gray-900 focus:!border-t-gray-900 focus:ring-gray-900/10 rounded-full"
                labelProps={{
                  className: "hidden",
                }}
                containerProps={{ className: "min-w-[100px]" }}
